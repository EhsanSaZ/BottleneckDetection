...
do
    ...
    then
      ...
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 33'&
      sleep 5;
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 56'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      stress-ng -c 0 -l 30 &
      sleep 5;
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 57'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      stress-ng -c 0 -l 70 &
      sleep 5;
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 58'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      stress-ng -c 0 -l 100 &
      sleep 5;
