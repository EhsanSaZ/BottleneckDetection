...
do
    ...
    then
      ...
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 82'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'stress-ng -c 0 -l 10'&
      sleep 5;
      python3 metric_collector.py 82 &
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 83'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'stress-ng -c 0 -l 30'&
      sleep 5;
      python3 metric_collector.py 83 &
      sleep $main_sleep_time;
      ssh root@$receiver_remote_client_ip 'killall -9 stress-ng';
      kill_all_java_python3_processes
      sleep 5;
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 84'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'stress-ng -c 0 -l 70'&
      sleep 5;
      python3 metric_collector.py 84 &
      sleep $main_sleep_time;
      ssh root@$receiver_remote_client_ip 'killall -9 stress-ng';
      kill_all_java_python3_processes
      sleep 5;
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /home/a/AgentMetricCollector/remote_metric_collector.py 85'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'stress-ng -c 0 -l 100'&
      sleep 5;
      python3 metric_collector.py 85 &
      sleep $main_sleep_time;
      ssh root@$receiver_remote_client_ip 'killall -9 stress-ng';
      kill_all_java_python3_processes
      sleep 5;
