...
# T ODO check this path with the path in target environment
...
# T ODO check this function work correctly
                ...
                if line_in_ss.count(dst_ip) >= 1:
                    ...
                    for x in range(len(parts)):
                        if dst_ip in parts[x] and port_number in parts[x]:
                            ...
                            # T ODO check this process_id with global pid
                    ...
                    # T ODO check these functions to work correctly
