...
def get_mdt_stat(mdt_dir_name, mdt_parent_path, mdt_paths, all_mdt_stat_so_far_dict=None):
    value_list = []
    value_list.append(len(mdt_paths))
    value_list += process_mds_rpc(mdt_parent_path + "/" + mdt_dir_name, mdt_dir_name)
    a_list, mdt_stat_latest_values = process_mdt_stat(mdt_parent_path + mdt_dir_name, mdt_dir_name, all_mdt_stat_so_far_dict.get(mdt_dir_name) or None)
    all_mdt_stat_so_far_dict[mdt_dir_name] = mdt_stat_latest_values
    return value_list, all_mdt_stat_so_far_dict
