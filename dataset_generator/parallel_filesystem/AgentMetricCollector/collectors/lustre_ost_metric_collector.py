...
class LustreOstMetricCollector(AbstractCollector):
    def __init__(self, prefix=""):
        ...
        self.metrics_id_to_attr = {152: 'remote_ost_read_bytes', 153: 'remote_ost_write_bytes'}
    ...
    def process_lustre_ost_stats(self, ost_agent_address, remote_ost_dir_name):
        if ost_agent_address != "":
            ...
            value_list.append(float((remote_ost_stats_latest_value.get("read_bytes") or 0) - (remote_ost_stats_so_far.get("read_bytes") or 0)))
            value_list.append(float((remote_ost_stats_latest_value.get("write_bytes") or 0) - (remote_ost_stats_so_far.get("write_bytes") or 0)))
