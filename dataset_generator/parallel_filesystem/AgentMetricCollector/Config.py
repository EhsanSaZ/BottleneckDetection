class Config:
    ...
    remote_parallel_metric_collector_server_ip = "127.0.0.1"
    remote_parallel_metric_collector_server_port_range = [50505, 50599]
    remote_parallel_metric_collector_client_ip = "134.197.94.169"
    ...
    remote_parallel_metric_collector_server_saving_directory = "/home/esaeedizade/data//dstData/" # used by the java client app
