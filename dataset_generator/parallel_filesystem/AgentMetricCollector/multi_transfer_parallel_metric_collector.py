...
global_metrics_collector_process = globalMetricsMonitor(1, global_vars.system_cpu_mem_usage, global_vars.system_cpu_mem_usage_dict, global_vars.system_buffer_value, global_vars.system_buffer_value_dict)
