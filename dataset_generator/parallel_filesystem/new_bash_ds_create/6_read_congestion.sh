...
# read_congestion_by_writer_on_other_ost
#congestions=([1]="read_congestion_by_writer_on_other_ost_1" [2]="read_congestion_by_writer_on_other_ost_2"
#[4]="read_congestion_by_writer_on_other_ost_4" [6]="read_congestion_by_writer_on_other_ost_6"
#[8]="read_congestion_by_writer_on_other_ost_8" [10]="read_congestion_by_writer_on_other_ost_10"
#[12]="read_congestion_by_writer_on_other_ost_12" [14]="read_congestion_by_writer_on_other_ost_14"
#[16]="read_congestion_by_writer_on_other_ost_16")
congestions=([1]="46" [2]="47" [4]="48" [6]="49" [8]="50" [10]="51" [12]="52" [14]="53" [16]="54")
while true
do
    printf "\n"
    ...
    for i in "${!congestions[@]}"; do
      ...
      ssh root@$receiver_remote_client_ip "python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/read_test.py /lustre/clientData/diskReadStress/ ${i}"&
      sleep 5;
