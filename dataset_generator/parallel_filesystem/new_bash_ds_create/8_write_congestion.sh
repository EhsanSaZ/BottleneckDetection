...
# write_congestion_by_clients_on_sender_ost
#congestions=([1]="write_congestion_by_clients_on_sender_ost_1" [2]="write_congestion_by_clients_on_sender_ost_2"
...
congestions=([1]="64" [2]="65" [4]="66" [6]="67" [8]="68" [10]="69" [12]="70" [14]="71" [16]="72")
while true
do
    printf "\n"
...
#      python3 /users/Ehsan/BottleneckDetection/dataset_generator/parallel_filesystem/AgentMetricCollector/DiskRWStress/write_test.py /lustre/dataDir/diskWriteStress/ $i&
      ssh root@$remote_client_ip "python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/write_test.py /lustre/dataDir/diskWriteStress/ ${i}"&
