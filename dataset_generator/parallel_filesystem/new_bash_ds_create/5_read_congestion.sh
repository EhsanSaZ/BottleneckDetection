...
##congestions=([1]="read_congestion_by_sender_on_other_ost_1" [2]="read_congestion_by_sender_on_other_ost_2"
##[4]="read_congestion_by_sender_on_other_ost_4" [6]="read_congestion_by_sender_on_other_ost_6"
##[8]="read_congestion_by_sender_on_other_ost_8" [10]="read_congestion_by_sender_on_other_ost_10"
##[12]="read_congestion_by_sender_on_other_ost_12" [14]="read_congestion_by_sender_on_other_ost_14"
##[16]="read_congestion_by_sender_on_other_ost_16")
#congestions=([1]="37" [2]="38" [4]="39" [6]="40" [8]="41" [10]="42" [12]="43" [14]="44" [16]="45")
#while true
#do
#    printf "\n"
...
#      python3 /users/Ehsan/BottleneckDetection/dataset_generator/parallel_filesystem/AgentMetricCollector/DiskRWStress/read_test.py /lustre/clientData/diskReadStress/ $i&
