...
# read_congestion_by_receiver_on_receiver_ost
...
congestions=([1]="19" [2]="20" [4]="21" [6]="22" [8]="23" [10]="24" [12]="25" [14]="26" [16]="27")
while true
do
    printf "\n"
    ...
    for i in "${!congestions[@]}"; do
      ...
      ssh root@$receiver_remote_client_ip "python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/read_test.py /lustre/dstDataDir/diskReadStress/  ${i}"&
      if $limited_bw
      then
