...
# read_congestion_by_clients_on_sender_ost
#congestions=([1]="read_congestion_by_clients_on_sender_ost_1" [2]="read_congestion_by_clients_on_sender_ost_2"
#[4]="read_congestion_by_clients_on_sender_ost_4" [6]="read_congestion_by_clients_on_sender_ost_6"
#[8]="read_congestion_by_clients_on_sender_ost_8" [10]="read_congestion_by_clients_on_sender_ost_10"
#[12]="read_congestion_by_clients_on_sender_ost_12" [14]="read_congestion_by_clients_on_sender_ost_14"
#[16]="read_congestion_by_clients_on_sender_ost_16")

congestions=([1]="10" [2]="11" [4]="12" [6]="13" [8]="14" [10]="15" [12]="16" [14]="17" [16]="18")
while true
do
    printf "\n"
...
#      python3 /users/Ehsan/BottleneckDetection/dataset_generator/parallel_filesystem/AgentMetricCollector/DiskRWStress/read_test.py /lustre/dataDir/diskReadStress/ $i&
      ssh root@$remote_client_ip "python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/read_test.py /lustre/dataDir/diskReadStress/ ${i}"&
