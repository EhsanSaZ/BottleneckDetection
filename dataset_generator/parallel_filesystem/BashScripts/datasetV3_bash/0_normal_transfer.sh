...
do
    ...
    ssh root@$receiver_ip "python3 /users/Ehsan/AgentMetricCollector/multi_transfer_parallel_metric_collector.py -l 0 -rj 2 -jsp 50505 -jtl ${label}"&
    if $limited_bw
    then
#      sudo tc qdisc add dev $ethernet_interface_name root netem delay ${network_bw};
    ...
    python3 ../../AgentMetricCollector/multi_transfer_parallel_metric_collector.py -l 0 -rj 1 -jlp 50521 -jtl ${label}&
