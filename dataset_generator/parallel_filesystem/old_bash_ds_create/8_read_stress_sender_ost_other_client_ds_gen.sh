...
do
    ...
    then
      ...
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/remote_parallel_metric_collector.py 62'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/read_test.py /lustre/dataDir/diskReadStress/ 2'&
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/remote_parallel_metric_collector.py 63'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/read_test.py /lustre/dataDir/diskReadStress/ 4'&
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/remote_parallel_metric_collector.py 64'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/read_test.py /lustre/dataDir/diskReadStress/ 8'&
    ...
    then
      clear_all_caches
      echo "Run the java server on receiver side and start metric collector agent";
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/remote_parallel_metric_collector.py 65'&
      sleep 5;
      echo "Start collecting metrics on sender side";
      ssh root@$receiver_remote_client_ip 'python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/read_test.py /lustre/dataDir/diskReadStress/ 16'&
