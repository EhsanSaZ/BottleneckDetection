...
class RemoteGetMdtStat:
    ...
    def process_mdt_stat(self, mdt_path, mdt_dir_name, mdt_stat_so_far):
        ...
        value_list.append(
            float((mdt_stat_latest_values.get("req_waittime") or 0) - (mdt_stat_so_far.get("req_waittime") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("req_active") or 0) - (mdt_stat_so_far.get("req_active") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_getattr") or 0) - (mdt_stat_so_far.get("mds_getattr") or 0)))
        value_list.append(float(
            (mdt_stat_latest_values.get("mds_getattr_lock") or 0) - (mdt_stat_so_far.get("mds_getattr_lock") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_close") or 0) - (mdt_stat_so_far.get("mds_close") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_readpage") or 0) - (mdt_stat_so_far.get("mds_readpage") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_connect") or 0) - (mdt_stat_so_far.get("mds_connect") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_get_root") or 0) - (mdt_stat_so_far.get("mds_get_root") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_statfs") or 0) - (mdt_stat_so_far.get("mds_statfs") or 0)))
        value_list.append(float((mdt_stat_latest_values.get("mds_sync") or 0) - (mdt_stat_so_far.get("mds_sync") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_quotactl") or 0) - (mdt_stat_so_far.get("mds_quotactl") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("mds_getxattr") or 0) - (mdt_stat_so_far.get("mds_getxattr") or 0)))
        value_list.append(float(
            (mdt_stat_latest_values.get("mds_hsm_state_set") or 0) - (mdt_stat_so_far.get("mds_hsm_state_set") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("ldlm_cancel") or 0) - (mdt_stat_so_far.get("ldlm_cancel") or 0)))
        value_list.append(float((mdt_stat_latest_values.get("obd_ping") or 0) - (mdt_stat_so_far.get("obd_ping") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("seq_query") or 0) - (mdt_stat_so_far.get("seq_query") or 0)))
        value_list.append(
            float((mdt_stat_latest_values.get("fld_query") or 0) - (mdt_stat_so_far.get("fld_query") or 0)))
        ...
        value_list.append(
            float((md_stats_latest_values.get("create") or 0) - (md_stats_so_far_dict.get("create") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("enqueue") or 0) - (md_stats_so_far_dict.get("enqueue") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("getattr") or 0) - (md_stats_so_far_dict.get("getattr") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("intent_lock") or 0) - (md_stats_so_far_dict.get("intent_lock") or 0)))
        value_list.append(float((md_stats_latest_values.get("link") or 0) - (md_stats_so_far_dict.get("link") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("rename") or 0) - (md_stats_so_far_dict.get("rename") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("setattr") or 0) - (md_stats_so_far_dict.get("setattr") or 0)))
        value_list.append(float((md_stats_latest_values.get("fsync") or 0) - (md_stats_so_far_dict.get("fsync") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("read_page") or 0) - (md_stats_so_far_dict.get("read_page") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("unlink") or 0) - (md_stats_so_far_dict.get("unlink") or 0)))
        value_list.append(
            float((md_stats_latest_values.get("setxattr") or 0) - (md_stats_so_far_dict.get("setxattr") or 0)))
        value_list.append(
