...
clear_all_caches
label='mds_congestion_by_clients_on_other_ost_0'
...
congestions=([1]="mds_congestion_by_clients_on_other_ost_1" [2]="mds_congestion_by_clients_on_other_ost_2"
[4]="mds_congestion_by_clients_on_other_ost_4" [6]="mds_congestion_by_clients_on_other_ost_6"
[8]="mds_congestion_by_clients_on_other_ost_8" [10]="mds_congestion_by_clients_on_other_ost_10"
[12]="mds_congestion_by_clients_on_other_ost_12" [14]="mds_congestion_by_clients_on_other_ost_14"
[16]="mds_congestion_by_clients_on_other_ost_16" [32]="mds_congestion_by_clients_on_other_ost_32"
[64]="mds_congestion_by_clients_on_other_ost_64" [96]="mds_congestion_by_clients_on_other_ost_96"
[128]="mds_congestion_by_clients_on_other_ost_128")
...
#  printf "%s\t%s\n" "$i" "${congestions[$i]}"
  ...
  ssh root@$receiver_remote_client_ip "java /users/Ehsan/AgentMetricCollector/collectors/SimpleReceiver_per_second_thr_monitor.java /lustre/dstDataDir/dstData/ 50505 ${label}"&
  sleep 5;
  ssh root@$remote_client_ip "python3 /users/Ehsan/AgentMetricCollector/DiskRWStress/mds_test_2.py ${i} 0"
